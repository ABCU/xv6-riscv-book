...
%% \newcommand{\fileref}[1]{\href{\github/#1}{\small{(\textcolor{blue}{\S)}}}}
%% \newcommand{\lineref}[2]{\href{\github/#1\#L#2}{\small{(\textcolor{blue}{\S})}}}
%% \newcommand{\linerefs}[3]{\href{\github/#1\#L#2-L#3}{\small{(\textcolor{blue}{\S})}}}
...
\newcommand{\showfileref}[1]{\href{\github/#1}{\small{(\textcolor{blue}{#1})}}}
