...
\lineref{user/sh.c:1}. (\textcolor{blue}{The link} is a hyperlink to
...
Commentary on UNIX 6th Edition~\cite{lions}. A good practice is to
read the source code first (in your favorite development environment,
on github, or in a PDF viewer) and come back later to this book, which
provides background to understand the code and clarifies
specific code fragments. By the end of this book you should be able to
understand every line of the xv6 source code.
