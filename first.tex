...
example,
one might use the {\tt fork} and {\tt exec} calls from
Chapter~\ref{CH:UNIX}
...
calls {\tt exec} to load the user program {\tt /init}.
...
however, that kernel code in general is correct, and follows
...
It's worthwhile to design safeguards into the
